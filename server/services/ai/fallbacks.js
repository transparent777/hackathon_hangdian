const FALLBACK_NOTES = {
  naiwa: {
    ...
    legendary: [
      '世界很吵，但我决定赖在这儿——哟齁齁，陪你把荒唐过完今天。',
      '光从窗帘缝里漏进来，落在你的杯子上，像谁偷偷打了个哈欠。'
    ]
  },
  doro: {
    normal: [
    ...
    legendary: [
      '最好的那瓣橘子，想留给你——有你陪着，我就不缩成一团了。',
      '窗外很亮，屋里很安静。心里慢慢暖起来，不想你走远。'
    ]
  },
  maodie: {
    normal: [
    ...
    legendary: [
      '别误会——不是温柔，是这儿有你在，我就默认也在。',
      '光影在地板上画了一道线，像领地边界。一切还算规矩。'
    ]
  }
}
...
function getFallbackDiaryNote(characterId, rarityKey) {
  ...
  const pool = bucket[rarityKey] || FALLBACK_NOTES.naiwa.normal
  return pickRandom(pool)
}

module.exports = {
  getFallbackDiaryNote,
  pickRandomDiaryNote: getFallbackDiaryNote
}
